  ...
  return (
    <div style={{ minHeight:'100vh', background:'#0c1014', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:'40px 24px' }}>
      ...
      <button
        ...
        style={{ width:280, padding:'28px 24px', textAlign:'left', cursor:'pointer', background:'#141e25', border:'1px solid rgba(184,216,232,0.1)', borderRadius:8, boxShadow:'0 8px 32px rgba(0,0,0,0.4)' }}
      >
        ...
        <div style={{ fontFamily:'Barlow,sans-serif', fontSize:'0.8rem', fontWeight:300, color:'#75848B', lineHeight:1.65 }}>Build athlete comparison graphics with live preview.</div>
